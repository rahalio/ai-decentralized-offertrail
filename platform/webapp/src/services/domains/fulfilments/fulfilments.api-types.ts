/**
 * Fulfilments API Types
 *
 * API contract types come from @offertrail/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @offertrail/core)
// ============================================================================
...
export type {
  // Add types from @offertrail/core/fulfilments
} from "@offertrail/core";

// Re-export with alias for backward compatibility if needed
// export type CoreFulfilmentsItem = FulfilmentsItem;
