...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/fulfilments\//, domain: "fulfilments" },
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      case "consents":
        ...
        break;
      case "fulfilments":
        domainDeps = buildFulfilmentsDomainModule(dynamoClient);
        break;
      case "identity":
...
export interface DomainDependencies {
  ...
  fulfilments: FulfilmentsDomainModule;
...
export function getFulfilmentsDeps(
  request: FastifyRequest,
): DomainDependencies["fulfilments"] {
  return getDomainDeps(request, "fulfilments");
}
