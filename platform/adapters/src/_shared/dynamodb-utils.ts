 ...
 *
 * @returns The core table name (e.g., "offertrail-core-dev")
 ...
 *
 * @returns The base table name (e.g., "offertrail-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "offertrail-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "offertrail-app-realtime-dev")
